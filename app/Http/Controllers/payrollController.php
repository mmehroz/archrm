                ...
                $dataemail = DB::connection('mysql')->table('employee')
                    ...
                    foreach($dataemail as $mailpersons)
                    {
                        ...
                        Mail::send('mail', ['mailpersons' => $mailpersons], function ($m) use ($mailpersons) { 
                            $m->from('muhammad.mehroz@arcinventador.com','Web');
                            $m->to($mailpersons->EMP_EMAIL, $mailpersons->EMP_NAME)->bcc('muhammad.mehroz@arcinventador.com')->subject(' Daily Attendance & Late Arrival Reports');
                         });
                    }
   ...
   /*  public function show_employeeData(){
    ...
    public function mail(){
        Mail::send('mail', ['name','Badar'], function ($m){ 
                            $m->from('muhammad.mehroz@arcinventador.com','Muhammad Mehroz');
                            $m->to('muhammad.mehroz@arcinventador.com', 'Muhammad Mehroz')->subject('IGNORE THIS TEST MAIL BY HR AND WEB DEPARTMENT');
                         });
