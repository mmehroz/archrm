									...
									<tr style="text-align: center;">
										...
										<td class="text-right">
											<div class="dropdown dropdown-action">
												<a href="{{ URL::to('/modalemployeeview/')}}/{{$datas->jobapplicant_id}}" target="_blank" ><i class="material-icons">more</i></a>
												<!---<div class="dropdown-menu dropdown-menu-right">
										...
										<td class="text-right">
											<div class="dropdown dropdown-action">
												<a href="{{ URL::to('/preemployementpdf')}}/{{$datas->jobapplicant_id}}" target="_blank" ><i class="material-icons">more</i></a>
												</div>
										</td>
