					...
					<div class="row staff-grid-row">
						<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3" style="float: left;">
							<div class="profile-widget">
								...
								<hr>
								<h6 class="text-left mt-" style="color: black"><span><i class="fa fa-user" style="color: #640d1d"></i></span> <span> {{$val->DESG_NAME}}</span></h6>
								<h6 class="text-left" style="color: black"><span><i class="fa fa-at" style="color: #640d1d"></i></span> {{$val->elsemployees_emailaddress}}</h6>
								<h6 class="text-left" style="color: black"><span><i class="fa fa-phone" style="color: #640d1d"></i></span> {{$val->elsemployees_ext}}</h6>
							</div>
							</div>
						</div>
						@endforeach
